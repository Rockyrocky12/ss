 ...
 * @author User
 */
public class Steph extends javax.swing.JFrame {
    ...
    public void setSub(Double psubtotal){
        this.sukli = getPrice() * getQuantity();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Steph.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
